        ...
        <div class="col col-md-11 p-4 p-md-5 rounded bg-white mx-3 mx-md-auto shadow-sm">
            <form method="POST" action="{{ route('client.update', $client->id) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group border rounded overflow-hidden">
                            <input class="form-control fs-14 shadow-none" type="text" name="uuid" id="uuid" value="{{ old('uuid', $client->uuid) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group border rounded overflow-hidden">
                            <input class="form-control fs-14 shadow-none" type="text" name="id_number" id="id_number" value="{{ old('id_number', $client->id_number) }}" required>
                            <span class="input-group-text bg-white border-0"><i class="bi bi-person-vcard"></i></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group border rounded overflow-hidden">
                            <input class="form-control fs-14 shadow-none" type="date" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $client->date_of_birth) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group border rounded overflow-hidden">
                            <input class="form-control fs-14 shadow-none" type="text" name="first_name" id="first_name" value="{{ old('first_name', $client->first_name) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group border rounded overflow-hidden">
                            <input class="form-control fs-14 shadow-none" type="text" name="last_name" id="last_name" value="{{ old('last_name', $client->last_name) }}" required>
                            <span class="input-group-text bg-white border-0"><i class="bi bi-person"></i></span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group border rounded overflow-hidden">
                            <input class="form-control fs-14 shadow-none" type="email" name="email" id="email" value="{{ old('email', $client->email) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group border rounded overflow-hidden">
                            <input class="form-control fs-14 shadow-none" type="text" name="telephone" id="telephone" value="{{ old('telephone', $client->telephone) }}" required>
                ...
                <div class="row my-4 mx-0">
                    <button type="submit" class="btn w-fit px-4 fw-bold fs-14 bg-brown text-white py-3">Update Client</button>
                </div>
            </form>
        </div>
    </div>
